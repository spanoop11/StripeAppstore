...
public final class PaymentMethodsAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder> {
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.stripe.android.model.PaymentMethod> getPaymentMethods$payments_core_release() {
        return null;
    }
    
    @org.jetbrains.annotations.Nullable()
    public final java.lang.String getSelectedPaymentMethodId$payments_core_release() {
        return null;
    }
    
    public final void setSelectedPaymentMethodId$payments_core_release(@org.jetbrains.annotations.Nullable()
    java.lang.String p0) {
    }
    ...
    @org.jetbrains.annotations.Nullable()
    public final com.stripe.android.view.PaymentMethodsAdapter.Listener getListener$payments_core_release() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.stripe.android.view.AddPaymentMethodActivityStarter.Args getAddCardArgs$payments_core_release() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final com.stripe.android.view.AddPaymentMethodActivityStarter.Args getAddFpxArgs$payments_core_release() {
        return null;
    }
     ...
     */
    @org.jetbrains.annotations.Nullable()
    public final java.lang.Integer getPosition$payments_core_release(@org.jetbrains.annotations.NotNull()
