...
public final class PaymentMethodsViewModel extends androidx.lifecycle.AndroidViewModel {
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.Set<java.lang.String> getProductUsage$payments_core_release() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.MutableLiveData<java.lang.String> getSnackbarData$payments_core_release() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.MutableLiveData<java.lang.Boolean> getProgressData$payments_core_release() {
        return null;
    }
    
    public final void onPaymentMethodAdded$payments_core_release(@org.jetbrains.annotations.NotNull()
    com.stripe.android.model.PaymentMethod paymentMethod) {
    }
    
    public final void onPaymentMethodRemoved$payments_core_release(@org.jetbrains.annotations.NotNull()
    com.stripe.android.model.PaymentMethod paymentMethod) {
    }
