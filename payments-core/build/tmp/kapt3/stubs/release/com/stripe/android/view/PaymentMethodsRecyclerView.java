...
public final class PaymentMethodsRecyclerView extends androidx.recyclerview.widget.RecyclerView {
    ...
    @org.jetbrains.annotations.NotNull()
    public final kotlin.jvm.functions.Function1<com.stripe.android.model.PaymentMethod, kotlin.Unit> getPaymentMethodSelectedCallback$payments_core_release() {
        return null;
    }
    
    public final void setPaymentMethodSelectedCallback$payments_core_release(@org.jetbrains.annotations.NotNull()
    kotlin.jvm.functions.Function1<? super com.stripe.android.model.PaymentMethod, kotlin.Unit> p0) {
    }
    
    @org.jetbrains.annotations.Nullable()
    public final com.stripe.android.model.PaymentMethod getTappedPaymentMethod$payments_core_release() {
        return null;
    }
    
    public final void setTappedPaymentMethod$payments_core_release(@org.jetbrains.annotations.Nullable()
