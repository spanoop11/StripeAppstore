...
public abstract class StripeRepositoryModule {
    ...
    @dagger.Binds()
    public abstract com.stripe.android.core.networking.AnalyticsRequestExecutor bindsAnalyticsRequestExecutor$payments_core_release(@org.jetbrains.annotations.NotNull()
    com.stripe.android.core.networking.DefaultAnalyticsRequestExecutor p0_772401952);
    
    @org.jetbrains.annotations.NotNull()
    @dagger.Binds()
    public abstract com.stripe.android.networking.StripeRepository bindsStripeRepository$payments_core_release(@org.jetbrains.annotations.NotNull()
