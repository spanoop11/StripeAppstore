...
public final class DefaultPaymentAuthenticatorRegistry implements com.stripe.android.payments.core.authentication.PaymentAuthenticatorRegistry, com.stripe.android.payments.core.injection.Injector {
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.stripe.android.payments.core.authentication.PaymentAuthenticator<? extends com.stripe.android.model.StripeModel>> getAllAuthenticators$payments_core_release() {
        return null;
    }
    
    @androidx.annotation.VisibleForTesting()
    @java.lang.Deprecated()
    public static void getAllAuthenticators$payments_core_release$annotations() {
    }
    ...
    @org.jetbrains.annotations.Nullable()
    public final androidx.activity.result.ActivityResultLauncher<com.stripe.android.PaymentRelayStarter.Args> getPaymentRelayLauncher$payments_core_release() {
        return null;
    }
    
    public final void setPaymentRelayLauncher$payments_core_release(@org.jetbrains.annotations.Nullable()
    androidx.activity.result.ActivityResultLauncher<com.stripe.android.PaymentRelayStarter.Args> p0) {
    }
    
    @org.jetbrains.annotations.Nullable()
    public final androidx.activity.result.ActivityResultLauncher<com.stripe.android.auth.PaymentBrowserAuthContract.Args> getPaymentBrowserAuthLauncher$payments_core_release() {
        return null;
    }
    
    public final void setPaymentBrowserAuthLauncher$payments_core_release(@org.jetbrains.annotations.Nullable()
