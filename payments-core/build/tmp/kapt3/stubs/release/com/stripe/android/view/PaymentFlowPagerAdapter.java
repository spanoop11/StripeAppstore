...
public final class PaymentFlowPagerAdapter extends androidx.viewpager.widget.PagerAdapter {
    ...
    @org.jetbrains.annotations.Nullable()
    public final com.stripe.android.model.ShippingInformation getShippingInformation$payments_core_release() {
        return null;
    }
    
    public final void setShippingInformation$payments_core_release(@org.jetbrains.annotations.Nullable()
    ...
    public final void setShippingInfoSubmitted$payments_core_release(boolean value) {
    }
    ...
    @org.jetbrains.annotations.Nullable()
    public final com.stripe.android.view.PaymentFlowPage getPageAt$payments_core_release(int position) {
        return null;
    }
