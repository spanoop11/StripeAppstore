...
public final class ShippingMethodAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.stripe.android.view.ShippingMethodAdapter.ShippingMethodViewHolder> {
    ...
    @org.jetbrains.annotations.NotNull()
    public final kotlin.jvm.functions.Function1<com.stripe.android.model.ShippingMethod, kotlin.Unit> getOnShippingMethodSelectedCallback$payments_core_release() {
        return null;
    }
    
    public final void setOnShippingMethodSelectedCallback$payments_core_release(@org.jetbrains.annotations.NotNull()
    ...
    public final void setSelectedIndex$payments_core_release(int value) {
    }
    ...
    public final void setSelected$payments_core_release(@org.jetbrains.annotations.NotNull()
    ...
    public static final class ShippingMethodViewHolder extends androidx.recyclerview.widget.RecyclerView.ViewHolder {
        ...
        @org.jetbrains.annotations.NotNull()
        public final com.stripe.android.view.ShippingMethodView getShippingMethodView$payments_core_release() {
            return null;
        }
